...
void MainWindow::handleButton(){
    ...
    QMessageBox::information(this, "Info", "Welcome Challenger! \n  You have just docked with the International Space Station.  \n "
"We have lost contact with the remaining astronauts and need you to investigate. \n Use the Compass Buttons on the right to navigate throughout the ISS.  \n"
"There is a basic map outlined above the compass. \n Good Luck.");
